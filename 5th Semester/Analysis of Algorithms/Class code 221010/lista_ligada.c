...
typedef struct
{                             // Definição do tipo da lista ligada.
...
{                              // Função principal do programa.
    ...
    do
    { // Início de um laço do-while de cadastro de elementos
        ...
        {                                                 // Por outro lado, se a lista não estiver vazia..
        ...
        do
        { // Início de um laço do-while de solicitação da opção.
